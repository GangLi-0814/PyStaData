<img src ="./images/7-0.png" style="zoom:60%;">

<img src ="./images/7-1.png" style="zoom:60%;">

## 1. 异方差的定义及后果

### 1.1 异方差的定义

**“条件异方差”**（简称“异方差”）是违背球型扰动假设的一种情形，即**条件方差 $Var(\epsilon_i|X)$ 依赖于 $i$ （  $Var(\epsilon_i|X) = \sigma _i ^2$ ），而不是常数 $\sigma^2$ 。**

【举例】考虑一元回归 $y_i = \alpha + \beta x_i + \epsilon$，假设 $Var(\epsilon_i | X)$ 是解释变量 $x_i$ 的增函数，即 $x_i$ 越大则 $Var(\epsilon_i|X)$ 越大。

<img src="/Users/gangli/PyStaData/PhD/Econometrics/陈强-计量经济学及Stata应用/images/7-1.png" style="zoom:70%"/>
...
<img src="/Users/gangli/PyStaData/PhD/Econometrics/陈强-计量经济学及Stata应用/images/7-0-1.png" style="zoom:50%"/>
...
```
<img src="/Users/gangli/PyStaData/PhD/Econometrics/陈强-计量经济学及Stata应用/images/7-0-3.png" style="zoom:50%"/>

<img src="/Users/gangli/PyStaData/PhD/Econometrics/陈强-计量经济学及Stata应用/images/7-0-4.png" style="zoom:50%"/>

从上面两张图可以看出，残差与拟合值、解释变量 `lnq` 之间呈现线性关系，由此猜测存在异方差。 
...
**假设样本数据为 iid** (Koenker, 1981)  ，则 $Var(\epsilon_i |X)= Var(\epsilon_i|X_i)$ 。
